...
class MilvusStoreWithClient:
    def __init__(self, client_uri: str = "http://localhost:19530", csv_file_path: str = "/Users/bartek/Documents/ai_persp/accenture-hackathon/backend/data/products.csv"):
    ...
    def hybrid_search(self,        
        ...
        return {"SCHEMA_NAME":res[0][0].entity.get('schema_name'),"TABLE_NAME":res[0][0].entity.get('table_name'),"TABLE_SCHEMA":res[0][0].entity.get("schema"),"IDS OF TABLES THAT ARE RELATED WITH GIVEN TABLE":res[0][0].entity.get('neighbours'), "TABLE CONSTRAINTS":res[0][0].entity.get('constraints')}


if __name__ == "__main__":
    # creating collection
    COLLECTION_NAME = "tests"
    milvus_store = MilvusStoreWithClient(csv_file_path="/Users/bartek/Documents/ai_persp/accenture-hackathon/backend/data/products.csv")
